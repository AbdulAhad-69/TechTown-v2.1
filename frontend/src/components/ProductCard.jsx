...
const ProductCard = ({ product }) => {
    // Bring in the addToCart function from our global Zustand store
    const addToCart = useCartStore(state => state.addToCart);

    // If the image is from Cloudinary, it starts with 'http'. 
    // Otherwise, it's a fallback local image.
    ...
    return (
        <div style={{
            ...
            <div>
                ...
                />
                <h3 style={{ fontSize: '18px', color: '#333', marginBottom: '10px' }}>{product.name}</h3>
